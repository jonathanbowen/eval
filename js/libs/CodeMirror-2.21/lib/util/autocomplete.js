CodeMirror.autoComplete = function(instance, words, num) {

    function autoComplete(instance, words, num) {
        ...
        var editor,                  // instance of CodeMirror
            ...
            currentIndex;            // index of current word in container
        ...
        function keyEvent(e) {
            ...
            if (!enabled || editor.somethingSelected() || e.type === 'keypress') return;
            ...
            switch (key) {
                ...
                // for other keys, scroll to matching word if any
                default:
    ...
    if (!instance.autoComplete)
        instance.autoComplete = autoComplete(instance, words, num);
