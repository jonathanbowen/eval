editAreaLoader.load_syntax["js"] = {
	...
	,'KEYWORDS' : {
		'statements' : [
 		...
 		,'keywords' : [
			...
			'Element', 'JavaPackage', 'opener', 'scrollbars', 'Window', 'escape', 'length', 'Option', 'scrollBy', 'undefined'			
		]
    	,'functions' : [
	...
	,'STYLES' : {
		...
		,'KEYWORDS' : {
			'statements' : 'color: #50a800;'
			,'keywords' : 'color: #0a1e8a;'
			,'functions' : 'color: #2B60FF;'
		}
		,'OPERATORS' : 'color: #FF00FF;'
		,'DELIMITERS' : 'color: #8a000c;'
